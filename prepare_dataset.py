...
def watermark(input_dir, output_dir):
    ...
    # for Encoder
    cmd = "python main_multibit.py --data_dir {} --output_dir {} --model_path {} --normlayer_path {} --data_augmentation none --batch_size 1 --target_psnr 33 --num_bits 32".format(input_dir, output_dir, model_path, normlayer_path)
    os.system(cmd)
